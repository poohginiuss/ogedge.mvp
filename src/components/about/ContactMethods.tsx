...
import { SupportTicketPopup } from "@/components/popups/SupportTicketPopup";
      ...
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            <a
              href="#whatsapp"
              className="flex h-[50px] w-[50px] cursor-pointer items-center justify-center rounded-2xl border border-dark-border transition-colors hover:border-brand-light"
              aria-label="WhatsApp"
            >
