          ...
          {questions.map((q, i) => {
            ...
            return (
              ...
              >
                <button
                  type="button"
                  className="flex w-full cursor-pointer items-center justify-between px-4 py-4 text-left transition-opacity hover:opacity-80 active:opacity-70 sm:px-6 sm:py-5 lg:px-8 lg:py-6"
