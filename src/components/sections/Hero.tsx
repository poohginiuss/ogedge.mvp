    ...
    <section className="relative w-full overflow-hidden">
      <div className="relative h-[600px] md:h-[720px] lg:h-[858px] w-full">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(17,17,17,0) 79%, rgb(17,17,17) 100%)",
          }}
        />

        <div className="relative z-10 flex h-full w-full items-center justify-center px-6">
          <div className="flex max-w-[568px] flex-col items-center gap-4 text-center">
            <h1 className="font-lexend text-3xl font-bold leading-tight text-white md:text-4xl lg:text-[36px]">
              Valorant Boosting
            </h1>
            <p className="font-urbanist text-base text-white md:text-xl lg:text-2xl lg:leading-8">
