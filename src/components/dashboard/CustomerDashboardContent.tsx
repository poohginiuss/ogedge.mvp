...
import { DashboardProfileCard } from "./customer/DashboardProfileCard";
import { DashboardReferralCard } from "./customer/DashboardReferralCard";
    ...
    <>
      ...
      <div className="flex flex-col gap-8 xl:flex-row xl:items-start xl:justify-between">
        <OrderSection
          ...
          onSeeAll={
            activeOrders.length > 0 ? () => router.push("/app/customer/active-orders") : undefined
          }
        >
