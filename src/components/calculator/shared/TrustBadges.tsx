  ...
  return (
    <div className="flex gap-4 overflow-x-auto xl:flex-wrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      {badges.map(({ icon, label }) => (
        <div
          key={label}
          className="inline-flex h-10 shrink-0 cursor-pointer items-center gap-2 rounded-3xl border border-transparent px-4 transition-all duration-200 hover:border-brand-light/40 hover:shadow-[0_0_12px_rgba(255,92,0,0.2)] active:scale-[0.97]"
          style={{
