...
export function JobsHero() {
  return (
    <section className="relative w-full overflow-hidden bg-dark-main">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center px-6 pb-10 pt-20 md:px-12 lg:flex-row lg:items-start lg:px-0 lg:pb-0 lg:pt-[80px]">
        {/* Left: text + CTA */}
        ...
        <div className="relative mt-10 h-[340px] w-[400px] md:h-[500px] md:w-[600px] lg:absolute lg:-top-[30px] lg:right-0 lg:mt-0 lg:h-[652px] lg:w-[756px]">
          <div
          ...
          <div
            className="absolute bottom-47.5 -left-10 -right-10 z-10 h-[200px] "
            style={{
              background:
